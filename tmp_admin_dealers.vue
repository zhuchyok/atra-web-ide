            ...
            <div class="flex-1 overflow-y-auto p-8 custom-scrollbar">
              <form @submit.prevent="handleSave" id="dealerForm" class="space-y-8">
                <div v-if="activeTab === 'basic'" class="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                  ...
                  <div class="space-y-6 pt-4 border-t border-gray-50">
                    <h4 class="text-[10px] font-black text-brand-blue uppercase tracking-[0.2em] ml-4">Коэффициенты по категориям</h4>
                    <div class="space-y-4">
                      <div
                      ...
                      >
                        ...
                        <div class="space-y-2">
                          <label class="text-[9px] font-black text-gray-400 uppercase tracking-widest ml-2">Коэффициент дилера</label>
                          <input
                        ...
                        <div class="space-y-2">
                          <label class="text-[9px] font-black text-gray-400 uppercase tracking-widest ml-2">Коэффициент клиента</label>
                          <input
