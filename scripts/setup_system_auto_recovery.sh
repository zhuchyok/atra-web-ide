...
echo ""
echo "📡 Чтобы оркестратор мог запрашивать восстановление при падении Ollama/MLX:"
echo "   Запустите на хосте: python3 scripts/host_recovery_listener.py (порт 9099)"
echo "   См. docs/ORCHESTRATOR_137_AND_OLLAMA.md §5–6."
echo ""
