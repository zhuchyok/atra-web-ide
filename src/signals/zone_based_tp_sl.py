    ...
    def calculate_tp_sl_from_fibonacci(
        ...
        try:
            ...
            fib_levels = self.fib_calculator.calculate_fibonacci_levels(
                df, lookback_periods=lookback_periods
            )
            ...
            if not fib_levels:
                ...
                return (
                    ...
                    base_tp2_pct,
                    base_sl_pct,
                    {"method": "base", "reason": "no_fib_levels"},
                )
            ...
            if direction == "LONG":
                ...
                return (
                    ...
                    sl_pct,
                    {
                        ...
                        "tp2_level": tp2_level.level
                        if levels_above and higher_resistances
                        else None,
        ...
        try:
            if not zones:
                return (
                    ...
                    base_tp2_pct,
                    base_sl_pct,
                    {"method": "base", "reason": "no_zones"},
                )

            if direction == "LONG":
                # LONG: TP на зонах сопротивления выше, SL на зонах поддержки ниже
                resistance_zones = [
                    z for z in zones if z.zone_type == "resistance" and z.low > entry_price
                ]
                support_zones = [
                    z for z in zones if z.zone_type == "support" and z.high < entry_price
                ]
                ...
                if resistance_zones:
                    higher_resistances = [
                        z for z in resistance_zones if z.low > (entry_price * (1 + tp1_pct / 100))
                    ]
                    if higher_resistances:
                ...
                return (
                    ...
                    sl_pct,
                    {
                        ...
                        "tp1_zone_strength": nearest_resistance.strength
                        if resistance_zones
                        else None,
                        "tp2_zone_strength": tp2_zone.strength
                        if resistance_zones and higher_resistances
                        else None,
                ...
                if support_zones:
                    lower_supports = [
                        z for z in support_zones if z.high < (entry_price * (1 - tp1_pct / 100))
                    ]
                    if lower_supports:
                ...
                return (
                    ...
                    sl_pct,
                    {
                        ...
                        "tp2_zone_strength": tp2_zone.strength
                        if support_zones and lower_supports
                        else None,
                        "sl_zone_strength": nearest_resistance.strength
                        if resistance_zones
                        else None,
                    },
                )
