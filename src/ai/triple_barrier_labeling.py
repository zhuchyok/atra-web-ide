...
class TripleBarrierLabeling:
    ...
    def label_trade(
        self, df: pd.DataFrame, entry_index: int, entry_price: float, side: str = "LONG"
...
def get_triple_barrier_labeling(
    tp_pct: float = 0.03, sl_pct: float = 0.015, max_hold_periods: int = 24, use_atr: bool = True
    ...
    if _triple_barrier_instance is None:
        _triple_barrier_instance = TripleBarrierLabeling(
            tp_pct=tp_pct, sl_pct=sl_pct, max_hold_periods=max_hold_periods, use_atr=use_atr
        )
