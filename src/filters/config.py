...
ANOMALY_FILTER = {
    ...
    # Типы аномалий
    "types": {
        "volume_spike": {"enabled": True, "threshold": 2.0, "description": "Резкий скачок объема"},
        "market_cap_change": {
            "enabled": True,
            "threshold": 1.5,
...
WHALE_FILTER = {
    ...
    "modes": {
        "free": {"enabled": True, "description": "Бесплатная версия (топ-100 китов)"},
        "premium": {"enabled": False, "description": "Платная версия (расширенный трекинг)"},
    },
}
