    ...
    try:
        ...
        if side.lower() == "long":
            ...
            if strict_mode:
                ...
                return (
                    False,
                    f"LONG: нет подтверждений перепроданности (MFI={mfi_value:.2f}, Stoch RSI={stoch_rsi_value:.2f})",
                )
            ...
            if strict_mode:
                ...
                return (
                    False,
                    f"SHORT: нет подтверждений перекупленности (MFI={mfi_value:.2f}, Stoch RSI={stoch_rsi_value:.2f})",
                )
