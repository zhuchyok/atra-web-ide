...
EXTERNAL_APIS = {
    ...
    "tradingview": {"enabled": True, "timeout": 15, "rate_limit": 30},
    "binance": {"enabled": True, "timeout": 5, "rate_limit": 1000},
}
...
API_RATE_LIMITS = {"coingecko": 50, "tradingview": 30, "binance": 1000, "default": 10}
...
NEWS_VALIDATION = {"min_title_length": 10, "max_title_length": 200, "max_items": 50}

# Диапазоны дат для валидации
DATE_VALIDATION = {"min_year": 2010, "max_future_days": 1}
