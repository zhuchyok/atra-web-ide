...
try:
    from src.bot_telegram.admin import add_user_cmd, list_users_cmd, remove_user_cmd
except ImportError:
    try:
...
try:
    from src.bot_telegram.metrics import metrics_cmd, performance_cmd, trades_cmd
except ImportError:
    try:
