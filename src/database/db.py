...
class Database:
    ...
    def _init_tables(self):
        ...
        self.cursor.execute(
            "CREATE INDEX IF NOT EXISTS idx_strategy_questions_session_id ON strategy_questions(session_id)"
        )
        self.cursor.execute(
            "CREATE INDEX IF NOT EXISTS idx_strategy_plans_session_id ON strategy_plans(session_id)"
        )
        self.cursor.execute(
            "CREATE INDEX IF NOT EXISTS idx_strategy_plans_parent_id ON strategy_plans(parent_plan_id)"
        )
        self.cursor.execute(
            "CREATE INDEX IF NOT EXISTS idx_strategy_plans_status ON strategy_plans(status)"
        )
        self.cursor.execute(
            "CREATE INDEX IF NOT EXISTS idx_strategy_actions_session_id ON strategy_actions(session_id)"
        )
        self.cursor.execute(
            "CREATE INDEX IF NOT EXISTS idx_strategy_actions_plan_id ON strategy_actions(plan_id)"
        )
