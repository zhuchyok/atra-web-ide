...
class FibonacciCalculator:
    ...
    def calculate_fibonacci_levels(
        ...
        try:
            ...
            for fib_pct in self.FIB_LEVELS:
                ...
                fib_levels.append(FibonacciLevel(level=fib_pct, price=fib_price, strength=strength))
    ...
    def find_nearest_fib_level(
        self, price: float, fib_levels: List[FibonacciLevel], tolerance_pct: float = 0.5
