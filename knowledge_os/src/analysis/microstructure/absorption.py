...
class AbsorptionLevels:
    ...
    def detect_absorption_levels(
        self, df: pd.DataFrame, i: Optional[int] = None
    ) -> List[Dict[str, Any]]:
        """
                    ...
                    absorption_levels.append(
                        {
                            ...
                            "timestamp": window_df.index[idx]
                            if hasattr(window_df.index[idx], "timestamp")
                            else idx,
                        }
                    )
    ...
    def _cluster_absorption_levels(
        self, levels: List[Dict[str, Any]], tolerance_pct: float = 0.5
    ) -> List[Dict[str, Any]]:
        """
    ...
    def _cluster_by_type(
        self, levels: List[Dict[str, Any]], tolerance_pct: float
    ) -> List[Dict[str, Any]]:
