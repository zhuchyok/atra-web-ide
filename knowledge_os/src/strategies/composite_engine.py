...
class CompositeSignalEngine:
    ...
    def calculate_composite_score(
        ...
        try:
            ...
            logger.debug("📊 Composite: trend=%.2f, mean_rev=%.2f, breakout=%.2f, volume=%.2f → score=%.2f (conf: %.2f)", 
    ...
    def update_strategy_performance(self, strategy: str, was_successful: bool, pnl_pct: float):
        ...
        logger.debug("📊 [ADAPTIVE] %s: total=%d, successful=%d, avg_pnl=%.2f%%",
    ...
    async def recalculate_adaptive_weights(self):
        ...
        try:
            ...
            logger.info("✅ [ADAPTIVE WEIGHTS] Веса обновлены: trend=%.2f, mean_rev=%.2f, breakout=%.2f, volume=%.2f",
