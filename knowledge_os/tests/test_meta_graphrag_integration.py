...
async def test_meta_architect_graphrag_integration():
    ...
    with patch('knowledge_os.app.meta_architect.get_profiler', return_value=mock_profiler), \
        ...
        with patch('knowledge_os.app.meta_architect.open', MagicMock()) as mock_open:
            ...
            mock_graphrag.retrieve_graph_context.assert_called_once_with("module test_module function test_function")
            ...
            assert "Учитывайте зависимости и логические связи, указанные в контексте GraphRAG" in mutation_prompt
