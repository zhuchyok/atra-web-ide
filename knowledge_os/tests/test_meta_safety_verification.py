...
"""
    ...
    with patch("knowledge_os.app.meta_architect.get_graphrag_service") as mock_get_graphrag, \
...
"""
    ...
    with patch("knowledge_os.app.meta_architect.get_graphrag_service") as mock_get_graphrag, \
        ...
        mock_run_agent.return_value = json.dumps({
            "safety_score": 0.2,
            "risks": ["Breaking signature: added mandatory argument 'c' without updating callers"],
