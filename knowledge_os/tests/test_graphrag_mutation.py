...
async def test_graphrag_context_injection():
    ...
    mock_result_json = json.dumps({
        "new_prompt": "Evolved prompt with GraphRAG knowledge and some very long text to pass validation. " * 5,
    ...
    with patch('asyncpg.connect', return_value=mock_conn), \
         ...
         patch('knowledge_os.app.expert_evolver.run_local_mutation_agent', new_callable=AsyncMock) as mock_agent, \
