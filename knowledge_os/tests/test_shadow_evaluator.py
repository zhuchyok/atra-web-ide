...
async def test_compare_responses_win():
    ...
    mock_router.run_local_llm.return_value = ('{"verdict": "Win", "reasoning": "Shadow is better", "winner": "Shadow"}', "ollama")
...
async def test_evaluate_and_update_full_cycle():
    ...
    # Мокаем всё
    mock_router = AsyncMock()
    mock_router.run_local_llm.return_value = ('{"verdict": "Loss", "reasoning": "Prod is better", "winner": "Production"}', "ollama")
    evaluator.router = mock_router
