...
from scripts.test_utils import TestResult, TestStatus, format_duration, measure_time
...
def test_disk_io() -> TestResult:
    ...
    try:
        ...
        return TestResult(
            ...
            metrics={"disk_usage_percent": disk_percent, "disk_free_gb": disk_free_gb},
        )
    except ImportError:
        return TestResult(
            name="Использование диска",
...
def run_all_performance_tests() -> list:
    ...
    tests = [test_cpu_usage, test_memory_usage, test_database_performance, test_disk_io]
