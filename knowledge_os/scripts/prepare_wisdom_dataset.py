# /Users/bikos/Documents/atra-web-ide/knowledge_os/scripts/prepare_wisdom_dataset.py
"""
...
async def synthesize_dataset():
    ...
    try:
        ...
        for row in rows:
            ...
            instruction = ""
            if node_type == 'evolution_log' or "гигант" in str(content).lower() or "google" in str(content).lower() or "openai" in str(content).lower():
