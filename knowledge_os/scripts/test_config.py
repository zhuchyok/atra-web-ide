...
REQUIRED_FILES = {
    ...
    "database": ["db.py", "database_initialization.py", "db_health_monitor.py"],
    "configuration": ["config.py", "src/core/config.py", "src/filters/config.py"],
    "monitoring": [
...
TELEGRAM_TOKENS = {"DEV": "DEV_TOKEN_REDACTED", "PROD": "PROD_TOKEN_REDACTED"}
...
METRICS_TO_TRACK = {
    "signals": ["total_generated", "total_accepted", "total_rejected", "filter_pass_rate"],
    "orders": [
        "total_executed",
    ...
    "performance": ["signal_generation_time", "order_execution_time", "cpu_usage", "memory_usage"],
}
...
SUCCESS_CRITERIA = {
    ...
    "files": {"all_required_files_exist": True, "all_modules_importable": True},
    "configuration": {
