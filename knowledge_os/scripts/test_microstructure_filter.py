...
def test_microstructure():
    ...
    for symbol in TEST_SYMBOLS:
        ...
        try:
            ...
            after_result = simple_backtest_with_microstructure(
                df, symbol, microstructure_before_baseline=False
            )
            before_result = simple_backtest_with_microstructure(
                df, symbol, microstructure_before_baseline=True
            )
    ...
    print("=" * 80)
    print("📈 MICROSTRUCTURE ПОСЛЕ baseline:")
    print(f"   Сделок: {total_after['trades']}, Return: {total_after['return']:+.2f}%")
    print("🔵 MICROSTRUCTURE ПЕРЕД baseline:")
