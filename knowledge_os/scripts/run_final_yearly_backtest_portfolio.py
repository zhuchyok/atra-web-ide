...
async def run_portfolio_backtest(symbols: List[str], days: int = 365) -> Dict[str, Any]:
    """
    ...
    for i, symbol in enumerate(symbols, 1):
        ...
        try:
            ...
            if result["total_trades"] > 0:
                ...
                total_losing_trades += result["total_trades"] - int(
    ...
    output_file = (
        ...
        / "data"
        / "reports"
        / f"final_portfolio_backtest_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
    )
