#!/usr/bin/env python3
"""
Бэктест MVP новых фильтров: Dominance Trend + Interest Zone
Сравнение: baseline (без фильтров) vs с новыми фильтрами
"""
...
async def run_backtest_with_filters(
    symbol: str,
    start_date: datetime,
    end_date: datetime,
...
async def run_comparison_backtest():
    """
    Запускает сравнительный бэктест: baseline vs с новыми фильтрами
    """
    logger.info("🚀 ЗАПУСК MVP БЭКТЕСТА: Сравнение новых фильтров")
    logger.info("=" * 70)
