...
# -*- coding: utf-8 -*-
"""
Обновление параметров для второй партии (25 монет) из результатов оптимизации
"""
...
# Загружаем результаты второй партии
result_file = Path('backtests/optimize_intelligent_params_20251213_225326.json')
