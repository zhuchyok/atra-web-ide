...
def test_signal_generation_basic() -> TestResult:
    ...
    try:
        ...
        from signal_live import add_technical_indicators, get_symbols
            ...
            return TestResult(
                ...
                details={
                    ...
                    "indicators_count": len(
                        [c for c in df_with_indicators.columns if c not in test_df.columns]
                    ),
...
def test_filters_import_and_structure() -> TestResult:
    ...
    try:
        ...
        test_results = {"imported": [], "failed": [], "details": {}}
        ...
        for module_name, class_name in filters_to_test:
            try:
                ...
                if filter_class:
                    ...
                    has_filter = (
                        hasattr(filter_class, "filter")
                        or hasattr(filter_class, "filter_signal")
                        or callable(filter_class)
                    )
                    if has_filter:
                        ...
                        test_results["failed"].append(
                            f"{class_name} (нет метода filter/filter_signal)"
                        )
...
def test_filter_execution() -> TestResult:
    ...
    try:
        ...
        try:
            from src.filters.btc_trend import (
                get_btc_trend_status,  # pylint: disable=import-outside-toplevel
            )
            ...
            filter_results["BTCTrendFilter"] = {"status": "ERROR", "error": str(e)[:100]}
        ...
        try:
            ...
            from src.signals.filters import (
                check_eth_alignment,  # pylint: disable=import-outside-toplevel
            )
            ...
            filter_results["ETHTrendFilter"] = {"status": "ERROR", "error": str(e)[:100]}
        ...
        try:
            ...
            from src.signals.filters import (
                check_sol_alignment,  # pylint: disable=import-outside-toplevel
            )
            ...
            filter_results["SOLTrendFilter"] = {"status": "ERROR", "error": str(e)[:100]}
        ...
        try:
            ...
            filter_results["AnomalyFilter"] = {"status": "ERROR", "error": str(e)[:100]}
    ...
    try:
        ...
        try:
            from src.strategies.adaptive_strategy import (
                AdaptiveStrategySelector,  # pylint: disable=import-outside-toplevel
            )
