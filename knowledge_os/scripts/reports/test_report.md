...
```json
{
  "tables": ["signals_log", "order_audit_log", "filter_performance"]
}
```
...
```json
{
  ...
  "methods_available": ["get_strategy"]
}
```
...
```json
{
  "scoring_systems": ["calculate_ai_signal_score"]
}
```
...
```json
{
  "found_methods": ["_get_current_price"]
}
```
...
```json
{
  "methods_available": ["log_order", "log_order_sync"]
}
```
