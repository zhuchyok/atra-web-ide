        ...
        if not force_refresh and self._structure_cache and ASYNCPG_AVAILABLE and self.db_url:
            try:
                ...
                if (self._last_expert_count is not None and 
                    ...
                    logger.info(f"🔄 Обнаружены изменения в структуре: экспертов {self._last_expert_count} → {current_expert_count}, отделов {self._last_department_count} → {current_dept_count}")
                    force_refresh = True
                ...
                async with self._structure_pool.acquire() as conn:
                    ...
                    for dept_row in departments:
                        ...
                        for emp in employees:
                            if emp['is_manager'] or emp['name'] in ['Игорь', 'Дмитрий', 'Сергей', 'Мария', 'Максим']:
                                manager = {
                                    "id": emp['id'],
                                    "name": emp['name'],
                                    "role": emp['role']
                    ...
                    logger.info(f"✅ Структура обновлена: {structure['total_departments']} отделов, {structure['total_employees']} сотрудников (корпорация растет!)")
                    return structure
            except Exception as pool_error:
            ...
            "departments": [
                {
                    ...
                    "employees": [
                        {"id": 1, "name": "Игорь", "role": "Backend Developer", "is_manager": True, "department": "Backend"},
                        {"id": 2, "name": "Даниил", "role": "Principal Backend Architect", "is_manager": False, "department": "Backend"},
                        {"id": 11, "name": "Роман", "role": "Database Engineer", "is_manager": False, "department": "Backend"},
                        {"id": 17, "name": "Никита", "role": "Full-stack Developer", "is_manager": False, "department": "Backend"}
                    ],
                    "employee_count": 4,
                    "subdepartments": []
                },
                {
                    ...
                    "employees": [
                        {"id": 3, "name": "Дмитрий", "role": "ML Engineer", "is_manager": True, "department": "ML/AI"},
                        {"id": 6, "name": "Максим", "role": "Data Analyst", "is_manager": False, "department": "ML/AI"}
                    ],
                    "employee_count": 2,
                    "subdepartments": []
                },
                {
                    ...
                    "employees": [
                        {"id": 4, "name": "Андрей", "role": "Frontend Developer", "is_manager": True, "department": "Frontend"},
                        {"id": 5, "name": "София", "role": "UI/UX Designer", "is_manager": False, "department": "Frontend"}
                    ],
                    "employee_count": 2,
                    "subdepartments": []
                },
                {
                    ...
                    "employees": [
                        {"id": 7, "name": "Сергей", "role": "DevOps Engineer", "is_manager": True, "department": "DevOps/Infra"},
                        {"id": 8, "name": "Елена", "role": "Monitor", "is_manager": False, "department": "DevOps/Infra"}
                    ],
                    "employee_count": 2,
                    "subdepartments": []
                },
                {
                    ...
                    "employees": [
                        {"id": 5, "name": "Анна", "role": "QA Engineer", "is_manager": True, "department": "QA"},
                        {"id": 21, "name": "Артем", "role": "Code Reviewer", "is_manager": False, "department": "QA"}
                    ],
                    "employee_count": 2,
                    "subdepartments": []
                },
                {
                    ...
                    "employees": [
                        {"id": 9, "name": "Алексей", "role": "Security Engineer", "is_manager": True, "department": "Security"}
                    ],
                    "employee_count": 1,
                    "subdepartments": []
                },
                {
                    ...
                    "employees": [
                        {"id": 10, "name": "Мария", "role": "Risk Manager", "is_manager": True, "department": "Risk Management"}
                    ],
                    "employee_count": 1,
                    "subdepartments": []
                },
                {
                    ...
                    "employees": [
                        {"id": 12, "name": "Ольга", "role": "Performance Engineer", "is_manager": True, "department": "Performance"}
                    ],
                    "employee_count": 1,
                    "subdepartments": []
                },
                {
                    ...
                    "employees": [
                        {"id": 13, "name": "Татьяна", "role": "Technical Writer", "is_manager": True, "department": "Documentation"}
                    ],
                    "employee_count": 1,
                    "subdepartments": []
                },
                {
                    "id": "Marketing",
                    "name": "Marketing",
                    "manager": {"id": 18, "name": "Дарья", "role": "SEO & AI Visibility Specialist"},
                    "employees": [
                        {"id": 18, "name": "Дарья", "role": "SEO & AI Visibility Specialist", "is_manager": True, "department": "Marketing"},
                        {"id": 19, "name": "Марина", "role": "Content Manager", "is_manager": False, "department": "Marketing"}
                    ],
                    "employee_count": 2,
                    "subdepartments": []
                },
                {
                    ...
                    "employees": [
                        {"id": 9, "name": "Павел", "role": "Trading Strategy Developer", "is_manager": True, "department": "Trading"},
                        {"id": 14, "name": "Екатерина", "role": "Financial Analyst", "is_manager": False, "department": "Trading"}
                    ],
                    "employee_count": 2,
                    "subdepartments": []
                },
                {
                    ...
                    "employees": [
                        {"id": 22, "name": "Анастасия", "role": "Product Manager", "is_manager": True, "department": "Product"}
                    ],
                    "employee_count": 1,
                    "subdepartments": []
                },
                {
                    ...
                    "employees": [
                        {"id": 20, "name": "Юлия", "role": "Legal Counsel", "is_manager": True, "department": "Legal"}
                    ],
                    "employee_count": 1,
                    "subdepartments": []
                }
