...
"""
    ...
    async def enhance_response_with_rag(
        self, user_query: str, model_response: str, use_context: bool = True
    ) -> Dict:
        """
        ...
        if not is_valid and context:
            ...
            enhanced_prompt = self.create_anti_hallucination_prompt(
                user_query, [c["content"] for c in context]
            )
