...
def main():
    ...
    col1.metric("Общие знания (L1+L2)", total_nodes, delta=f"+{data['remote'].get('nodes', 0)} с сервера" if data["online"] else "OFFLINE")
    ...
    levels = {0: "👑 Координаторы (Level 0)", 1: "👔 Лиды отделов (Level 1)", 2: "🛠 Специалисты (Level 2)"}
