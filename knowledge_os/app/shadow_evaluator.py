...
class ShadowEvaluator:
    ...
    async def compare_responses(self, query: str, prod_resp: str, shadow_resp: str) -> Dict[str, Any]:
        """
...
VERDICT:"""
        ...
        try:
            ...
            try:
                ...
                if start_idx != -1 and end_idx != 0:
                    ...
                    evaluation = {"verdict": "Draw", "reasoning": f"Invalid JSON format: {raw_response[:100]}", "winner": "None"}
            except json.JSONDecodeError:
                evaluation = {"verdict": "Draw", "reasoning": f"Failed to parse JSON: {raw_response[:100]}", "winner": "None"}
    ...
    async def evaluate_and_update(self, mutation_id: str, query: str, prod_resp: str, shadow_resp: str):
        """
