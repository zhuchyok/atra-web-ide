...
ROLE_PERMISSIONS = {
    ...
    Role.USER: [Permission.READ_KNOWLEDGE, Permission.WRITE_KNOWLEDGE, Permission.VIEW_ANALYTICS],
    Role.READONLY: [Permission.READ_KNOWLEDGE, Permission.VIEW_ANALYTICS],
    Role.API: [Permission.READ_KNOWLEDGE, Permission.WRITE_KNOWLEDGE],
}
...
class SecurityManager:
    ...
    async def create_user(
        self, username: str, password: str, role: Role, email: Optional[str] = None
    ) -> Optional[str]:
        ...
        try:
            ...
            try:
                ...
                await self.log_audit_event(
                    str(user["id"]), "authentication", "success", {"username": username}
                )
    ...
    async def log_audit_event(
        self, user_id: str, action: str, status: str, details: Dict[str, Any] = None
    ) -> Optional[str]:
