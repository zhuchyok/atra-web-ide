...
try:
    ...
    logger.debug(
        "ℹ️ OpenTelemetry не установлен (опциональный компонент). Для установки: pip install opentelemetry-api opentelemetry-sdk opentelemetry-exporter-otlp"
    )
...
class ObservabilityManager:
    ...
    def __init__(self, service_name: str = "atra-enhanced", enable_console: bool = True):
        ...
        self.enabled = (
            OPENTELEMETRY_AVAILABLE and os.getenv("ENABLE_OTEL", "false").lower() == "true"
        )
        self.tracer = None
