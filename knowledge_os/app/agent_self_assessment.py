...
class AgentSelfAssessment:
    ...
    async def assess_task_performance(
        self, agent_id: str, task_id: str, task_result: Dict[str, Any]
        ...
        try:
            ...
            if conn:
                try:
                    ...
                    logger.info(
                        f"✅ [SELF ASSESSMENT] Оценка {assessment_id} для агента {agent_id}: score={performance_score:.2f}"
                    )
                    return assessment
    ...
    async def create_improvement_plan(
        self, agent_id: str, improvements: List[str], priority: str = "medium"
        ...
        try:
            ...
            if conn:
                try:
                    ...
                    logger.info(
                        f"✅ [SELF ASSESSMENT] Создан план улучшений {plan_id} для агента {agent_id}"
                    )
                    return plan
                ...
                active_plans = [
                    {
                        ...
                        if isinstance(row["improvements"], str)
                        else row["improvements"],
