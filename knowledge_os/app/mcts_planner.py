...
class MCTSPlanner:
    ...
    async def plan(self, goal: str, context: str = "") -> List[str]:
        ...
        self.root = MCTSNode(
            node_id="root", action="Start", state_description=f"Initial state for: {goal}"
        )
    ...
    async def _expand(self, node: MCTSNode, goal: str, context: str) -> MCTSNode:
        ...
        try:
            ...
            response = await run_smart_agent_async(
                expansion_prompt, expert_name="Architect", category="reasoning"
            )
    ...
    async def _simulate(self, node: MCTSNode, goal: str, context: str) -> float:
        ...
        try:
            ...
            response = await run_smart_agent_async(
                simulation_prompt, expert_name="Architect", category="reasoning"
            )
