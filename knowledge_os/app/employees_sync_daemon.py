...
DB_URL = os.getenv(
    "DATABASE_URL",
    "postgresql://admin:secret@localhost:6432/knowledge_os?application_name=sync_daemon",
)
...
DIRECT_DB_URL = os.getenv(
    "POSTGRES_DIRECT_URL",
    "postgresql://admin:secret@localhost:5432/knowledge_os?application_name=sync_daemon_direct",
)
