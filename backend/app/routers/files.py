...
async def write_file(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Internal server error while writing file")


@router.post("/create")
async def create_item(
    path: str = Query(..., description="Путь", max_length=500), request: CreateRequest = None
) -> dict:
    """
    ...
    try:
        ...
        return {"success": True, "path": path, "type": request.type}

    except HTTPException:
        raise
    except Exception as e:
        logger.error(f"Create error: {e}", exc_info=True)
        raise HTTPException(status_code=500, detail="Internal server error while creating item")


@router.delete("/delete")
async def delete_item(path: str = Query(..., description="Путь", max_length=500)) -> dict:
    """
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Internal server error while deleting item")
...
async def rename_item(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Internal server error while renaming item")
