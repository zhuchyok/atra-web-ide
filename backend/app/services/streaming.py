...
class StreamingProcessor:
    ...
    def __init__(self, buffer_size: int = 5, min_delay: float = 0.05, max_delay: float = 0.2):
    ...
    async def process_stream(
        self, source: AsyncGenerator[str, None], on_chunk: Optional[Callable] = None
...
async def stream_with_processing(
    source: AsyncGenerator[str, None], processor: Optional[StreamingProcessor] = None
...
def create_sse_event(event_type: str, data: dict, event_id: Optional[str] = None) -> str:
    """
