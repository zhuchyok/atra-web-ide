...
**Итог:** Предложение «план пишет Victoria» — правильное и лучшее. Orchestrator может _запросить_ план у Victoria для сложных задач из БД; Veronica план не пишет.
