...
| Исторические отчёты из корня | [archive/root_reports/](archive/root_reports/)         | COMPLETE*\*, FINAL*_, VICTORIA\__, TELEGRAM\_\*, отчёты о миграции и статусах. Для текущей работы — docs/ (MASTER_REFERENCE, таблица §8). |
