...
| Действие                                           | Кто       | Где                                                                                      |
| -------------------------------------------------- | --------- | ---------------------------------------------------------------------------------------- |
| Прогон куратора, сравнение с эталонами             | Куратор   | run*curator_scheduled.sh, curator_compare_to_standard.py, FINDINGS*\*.md                 |
...
| Фиксация новых причин                              | Оба       | Этот файл, FINDINGS\_\*.md, CHANGES_FROM_OTHER_CHATS                                     |
