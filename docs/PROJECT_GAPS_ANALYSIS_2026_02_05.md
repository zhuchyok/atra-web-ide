...
_Отчёт подготовлен по методологии проекта: чеклист верификации, причины сбоев, рекомендации специалистов. При следующих изменениях учитывать §5 VERIFICATION_CHECKLIST_OPTIMIZATIONS и обновлять библию._
