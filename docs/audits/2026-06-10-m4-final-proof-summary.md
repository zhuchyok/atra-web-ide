...
- started_at_utc: `2026-06-10T05:23:07.602750+00:00`
- last_sample_utc: `2026-06-10T05:33:34.460112+00:00`
...
- 15m: pass=`True` active=`False` reason=`insufficient_load_n_a` stability_ok=`True` throughput_ok=`False` throughput_eligible=`False` min_completed_required=`1` samples=`20` completed_delta=`0` completed10m_ratio=`0.00` max_pending=`3` max_in_progress=`4` max_stale=`0` distill_tail_ok=`True` max_eligible_now=`0` tail_breach_streak_max=`0`
- 1h: pass=`True` active=`False` reason=`insufficient_load_n_a` stability_ok=`True` throughput_ok=`False` throughput_eligible=`False` min_completed_required=`3` samples=`20` completed_delta=`0` completed10m_ratio=`0.00` max_pending=`3` max_in_progress=`4` max_stale=`0` distill_tail_ok=`True` max_eligible_now=`0` tail_breach_streak_max=`0`
- 6h: pass=`True` active=`False` reason=`insufficient_load_n_a` stability_ok=`True` throughput_ok=`False` throughput_eligible=`False` min_completed_required=`18` samples=`20` completed_delta=`0` completed10m_ratio=`0.00` max_pending=`3` max_in_progress=`4` max_stale=`0` distill_tail_ok=`True` max_eligible_now=`0` tail_breach_streak_max=`0`
- 24h: pass=`True` active=`False` reason=`insufficient_load_n_a` stability_ok=`True` throughput_ok=`False` throughput_eligible=`False` min_completed_required=`72` samples=`20` completed_delta=`0` completed10m_ratio=`0.00` max_pending=`3` max_in_progress=`4` max_stale=`0` distill_tail_ok=`True` max_eligible_now=`0` tail_breach_streak_max=`0`
