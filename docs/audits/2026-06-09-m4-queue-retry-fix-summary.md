...
- started_at_utc: `2026-06-09T21:37:23.898650+00:00`
- last_sample_utc: `2026-06-09T21:43:15.426145+00:00`
...
- 15m: pass=`True` active=`False` reason=`insufficient_load_n_a` stability_ok=`True` throughput_ok=`False` throughput_eligible=`False` min_completed_required=`1` samples=`18` completed_delta=`0` completed10m_ratio=`0.00` max_pending=`2` max_in_progress=`8` max_stale=`0` distill_tail_ok=`True` max_eligible_now=`0` tail_breach_streak_max=`0`
- 1h: pass=`True` active=`False` reason=`insufficient_load_n_a` stability_ok=`True` throughput_ok=`False` throughput_eligible=`False` min_completed_required=`3` samples=`18` completed_delta=`0` completed10m_ratio=`0.00` max_pending=`2` max_in_progress=`8` max_stale=`0` distill_tail_ok=`True` max_eligible_now=`0` tail_breach_streak_max=`0`
- 6h: pass=`True` active=`False` reason=`insufficient_load_n_a` stability_ok=`True` throughput_ok=`False` throughput_eligible=`False` min_completed_required=`18` samples=`18` completed_delta=`0` completed10m_ratio=`0.00` max_pending=`2` max_in_progress=`8` max_stale=`0` distill_tail_ok=`True` max_eligible_now=`0` tail_breach_streak_max=`0`
- 24h: pass=`True` active=`False` reason=`insufficient_load_n_a` stability_ok=`True` throughput_ok=`False` throughput_eligible=`False` min_completed_required=`72` samples=`18` completed_delta=`0` completed10m_ratio=`0.00` max_pending=`2` max_in_progress=`8` max_stale=`0` distill_tail_ok=`True` max_eligible_now=`0` tail_breach_streak_max=`0`
