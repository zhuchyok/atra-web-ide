...
- started_at_utc: `2026-06-20T20:43:47.743582+00:00`
- last_sample_utc: `2026-06-20T20:58:34.722057+00:00`
...
## Gate Results
- 15m: pass=`True` active=`True` reason=`ok` stability_ok=`True` throughput_ok=`True` throughput_eligible=`True` min_completed_required=`1` samples=`27` completed_delta=`2` completed10m_ratio=`0.74` max_pending=`2` max_in_progress=`2` max_stale=`0` distill_tail_ok=`True` max_eligible_now=`2` tail_breach_streak_max=`0` dynamic_alert_ok=`True` max_dynamic_alert_count=`0`
- 1h: pass=`True` active=`True` reason=`insufficient_load_n_a` stability_ok=`True` throughput_ok=`False` throughput_eligible=`False` min_completed_required=`3` samples=`27` completed_delta=`2` completed10m_ratio=`0.74` max_pending=`2` max_in_progress=`2` max_stale=`0` distill_tail_ok=`True` max_eligible_now=`2` tail_breach_streak_max=`0` dynamic_alert_ok=`True` max_dynamic_alert_count=`0`
- 6h: pass=`True` active=`True` reason=`insufficient_load_n_a` stability_ok=`True` throughput_ok=`False` throughput_eligible=`False` min_completed_required=`18` samples=`27` completed_delta=`2` completed10m_ratio=`0.74` max_pending=`2` max_in_progress=`2` max_stale=`0` distill_tail_ok=`True` max_eligible_now=`2` tail_breach_streak_max=`0` dynamic_alert_ok=`True` max_dynamic_alert_count=`0`
- 24h: pass=`True` active=`True` reason=`insufficient_load_n_a` stability_ok=`True` throughput_ok=`False` throughput_eligible=`False` min_completed_required=`72` samples=`27` completed_delta=`2` completed10m_ratio=`0.74` max_pending=`2` max_in_progress=`2` max_stale=`0` distill_tail_ok=`True` max_eligible_now=`2` tail_breach_streak_max=`0` dynamic_alert_ok=`True` max_dynamic_alert_count=`0`
