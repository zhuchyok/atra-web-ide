...
- `docs/mac-studio/` — VICTORIA*\*, MIGRATION*_, MAC*STUDIO*_, MLX\_\*, DOCKER_AFTER_MIGRATION, MIGRATION_PROBLEM_AGENTS
...
_Скопировано из atra. Полные знания по Knowledge OS, экспертам и миграции — в репо atra._
